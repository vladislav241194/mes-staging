...
export const MES_FLOW_MODULES = {
  ...
  operations: {
    ...
    modules: ["Диспетчерская", "Мастерская", "Журнал СЗН", "Матрица"],
    owns: ["shiftWorkOrder"],
  },
};
...
export const MES_MODULE_FLOW_CONTRACTS = {
  ...
  matrix: {
    ...
    label: "Матрица",
    group: "Оперативное управление",
    role: "Read-only матрица загрузки ресурсов по дням на основе текущих слотов Gantt.",
    reads: ["Слоты планирования", "Ресурсы", "Календарь", "Предупреждения Gantt"],
    writes: [],
    ganttImpact: "none",
    ganttVisualChange: "—",
    editPolicy: "Не изменяет слоты, статусы, зависимости или фактические данные; только показывает оперативный срез.",
  },
  shiftMasterBoard: {
    id: "shiftMasterBoard",
    label: "Мастерская",
