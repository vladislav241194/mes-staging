...
export const UI_RUNTIME_COMPONENT_CONTRACTS = [
  ...
  },
  {
    ...
    helperNames: ["renderUiTableControlAttributes"],
    cssSelectors: ["[data-ui-component=\"TableControl\"]"],
    purpose: "Input/select внутри производственных таблиц: общая поверхность и типографика при явной плотности предметной сетки.",
  },
  {
    component: "InfoGrid",
    helperNames: ["renderUiInfoGrid"],
    cssSelectors: [".ui-info-grid", ".ui-info-card", "[data-ui-component=\"InfoGrid\"]", "[data-ui-component=\"InfoCard\"]"],
    purpose: "Горизонтальная группа информационных карточек для hero/summary без локального CSS.",
  },
  {
    component: "MetricGrid",
    helperNames: ["renderUiMetricGrid"],
    cssSelectors: [".ui-metric-grid", ".ui-metric-card", "[data-ui-component=\"MetricGrid\"]", "[data-ui-component=\"MetricCard\"]"],
    purpose: "Сетка KPI/метрик с единой типографикой, inset и поверхностью.",
  },
  {
    component: "FormField",
  ...
  },
  {
    ...
    helperNames: ["renderUiFormSection"],
    cssSelectors: [".ui-form-section", ".ui-form-section-head", ".ui-form-section-body"],
    purpose: "Смысловой раздел формы с единым заголовком, описанием и action-slot.",
  },
  {
    component: "FormGrid",
    helperNames: ["renderUiFormGrid"],
    cssSelectors: [".ui-form-grid"],
    purpose: "Адаптивная сетка полей с системными columns и density variants.",
  },
  {
    component: "FormRow",
    helperNames: ["renderUiFormRow"],
    cssSelectors: [".ui-form-row"],
    purpose: "Строка связанных контролов без локальной flex/grid геометрии.",
  },
  {
    component: "FormActions",
    helperNames: ["renderUiFormActions"],
    cssSelectors: [".ui-form-actions"],
    purpose: "Единая зона submit/cancel/destructive действий формы.",
  },
  {
    component: "Dropdown",
  ...
  },
  {
    ...
    helperNames: ["renderUiSystemState"],
    cssSelectors: [".ui-system-state", ".ui-system-state-copy", ".ui-system-state-action"],
    purpose: "Единый loading/error/warning/access state с optional action.",
  },
];
...
export const UI_RUNTIME_STYLE_TOKENS = [
  ...
  "--mes-ui-contract-page-bg-soft",
  "--mes-ui-contract-page-bg-admin",
  "--mes-ui-contract-panel-bg",
  "--mes-ui-contract-card-bg",
  "--mes-ui-contract-subblock-bg",
  "--mes-ui-contract-table-head-bg",
  "--mes-ui-contract-table-head-text",
  "--mes-ui-contract-table-head-muted",
  "--mes-ui-contract-line",
  "--mes-ui-contract-line-strong",
  "--mes-ui-contract-chip-line",
  "--mes-ui-contract-muted",
  "--mes-ui-contract-shadow-soft",
  "--mes-ui-contract-table-head-shadow",
  "--mes-ui-contract-page-pad",
  "--mes-ui-contract-section-gap",
  "--mes-ui-contract-panel-pad",
  "--mes-ui-contract-card-pad",
  "--mes-ui-contract-cell-pad",
  "--mes-ui-shell-sidebar-bg",
  "--mes-ui-shell-sidebar-edge",
  "--mes-ui-shell-brand-border",
  "--mes-ui-shell-tab-hover-bg",
  "--mes-ui-shell-tab-hover-border",
  "--mes-ui-shell-tab-active-bg",
  "--mes-ui-shell-tab-active-border",
  "--mes-ui-surface",
  "--mes-ui-surface-soft",
  ...
  "--mes-ui-form-section-gap",
  "--mes-ui-form-grid-gap",
  "--mes-ui-form-grid-min-column",
  "--mes-ui-form-row-gap",
  "--mes-ui-form-state-padding",
  "--mes-ui-form-message-color",
  ...
  "--mes-ui-control-gap",
  "--mes-ui-dropdown-z-index",
  "--mes-ui-dropdown-min-width",
  "--mes-ui-dropdown-max-width",
  "--mes-ui-dropdown-max-height",
  "--mes-ui-dropdown-viewport-gap",
...
export const UI_RUNTIME_DOM_NORMALIZER_CONTRACTS = [
  { component: "FormField", selector: ".form-field, .ui-form-field" },
  {
    ...
    selector: "label:has(input):not(.form-field):not(.ui-form-field), label:has(select):not(.form-field):not(.ui-form-field), label:has(textarea):not(.form-field):not(.ui-form-field)",
  },
  { component: "FormSection", selector: ".ui-form-section" },
  { component: "FormGrid", selector: ".ui-form-grid" },
  { component: "FormRow", selector: ".ui-form-row" },
  { component: "FormActions", selector: ".ui-form-actions" },
  {
    component: "ActionButton",
    selector: ".ui-action-button, :is(button, label):is(.primary-button, .secondary-button, .icon-button, .table-icon-button, .danger-primary)",
  },
  {
    component: "DomainControl",
    selector: "button:not([data-ui-component])",
  },
  ...
  { component: "SystemState", selector: ".ui-system-state" },
