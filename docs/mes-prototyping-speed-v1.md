...
РКД удален из системы полностью. Его можно упоминать только в документации как удаленный модуль; runtime, CSS, module alias и новые пункты навигации с `rkd` запрещены.
