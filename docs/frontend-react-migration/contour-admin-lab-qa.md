...
- full aggregate lab `512,656 B / 118,010 B` under its development-only
  `515,000 B / 125,000 B` budget;
- shared lab CSS `22,053 B / 4,332 B` under its development-only
  `22,500 B / 4,600 B` budget.
