...
- Актуальный кодовый checkpoint: `8fb92d9` (`fix(react): clear ready island busy state`)
...
- Historical Pilot read ledger: `21/24` принятых сценариев на разных
  релизах; current-release read на `.21` — `2/24`.
...
- На `v.1.500.21-8fb92d9` без evaluation-флагов постоянно включены
