...
- Актуальный кодовый checkpoint: `1f8369c` (`test(react): cover awaited nomenclature dispatch`)
...
- Historical Pilot read ledger: `21/24` принятых сценариев на разных
  релизах; accepted-permanent-baseline read на `.21` — `2/24`;
  Nomenclature дополнительно принят evaluation lifecycle на live `.25`.
...
- На live `v.1.500.25-1f8369c` без evaluation-флагов постоянно включены
