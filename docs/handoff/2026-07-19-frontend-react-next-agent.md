...
> доказанный прогресс — `50%`. Текущий Pilot —
> `v.1.500.26-097d66c`; fresh current-release read — `1/24`, historical
...
- Historical Pilot read ledger: `21/24` принятых сценариев на разных
  релизах; fresh current-release read на `.26` — `1/24` (только Weekly);
...
- Активный release: `v.1.500.26-097d66c`; immediate previous:
  `v.1.500.25-1f8369c`; pinned legacy:
  `v.1.500.18-93d02ed`.
