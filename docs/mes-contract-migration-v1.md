...
- Сменный заказ-наряд получил `flowIn` из слота Ганта и закрытие факта внутри Мастерской с записью в архив факта.
