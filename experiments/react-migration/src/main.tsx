...
const initialPayload = scenario === "componentTypes" ? componentTypesFixture : scenario === "boards" ? boardsFixture : scenario === "structureEmployees" ? structureEmployeesFixture : scenario === "structurePositions" ? structurePositionsFixture : scenario === "structureOrgUnits" ? structureOrgUnitsFixture : scenario === "structureWorkCenters" ? structureWorkCentersFixture : scenario === "structureEquipment" ? structureEquipmentFixture : scenario === "roles" ? rolesFixture : scenario === "operations" ? operationsFixture : scenario === "nomenclatureTypes" ? nomenclatureTypesFixture : scenario === "statuses" ? statusesFixture : nomenclatureFixture;
