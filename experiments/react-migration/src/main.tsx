...
import { createShiftMasterBoardAssignmentFixture, createShiftMasterBoardCarryoverFixture, createShiftMasterBoardDateFixture, createShiftMasterBoardFactFixture, createShiftMasterBoardFocusFixture, createShiftMasterBoardLaneFixture, createShiftMasterBoardMasterFixture, shiftMasterBoardFixture, shiftMasterBoardUpdateFixture } from "./modules/shift-master-board/fixture";
...
const scenarioParamRoutes = ["nomenclature", "component-types", "boards", "structure-employees", "structure-positions", "structure-org-units", "structure-work-centers", "structure-equipment", "structure-responsibility-policies", "structure-migration-diagnostics", "weekly-production-control", "timesheet", "planning-workbench", "shift-work-orders", "shift-master-board", "employee-desktop", "contour-admin", "specifications2", "roles", "operations", "nomenclature-types", "statuses"] as const;
const labInitialPayloads: readonly unknown[] = [nomenclatureFixture, componentTypesFixture, boardsFixture, structureEmployeesFixture, structurePositionsFixture, structureOrgUnitsFixture, structureWorkCentersFixture, structureEquipmentFixture, structureResponsibilityPoliciesFixture, structureMigrationDiagnosticsFixture, weeklyProductionControlFixture, timesheetFixture, planningWorkbenchFixture, shiftWorkOrdersFixture, shiftMasterBoardFixture, employeeDesktopFixture, contourAdminFixture, specifications2Fixture, rolesFixture, operationsFixture, nomenclatureTypesFixture, statusesFixture];
const labUpdatePayloads: readonly unknown[] = [nomenclatureUpdateFixture, componentTypesUpdateFixture, boardsUpdateFixture, structureEmployeesUpdateFixture, structurePositionsUpdateFixture, structureOrgUnitsUpdateFixture, structureWorkCentersUpdateFixture, structureEquipmentUpdateFixture, structureResponsibilityPoliciesUpdateFixture, structureMigrationDiagnosticsUpdateFixture, weeklyProductionControlUpdateFixture, timesheetUpdateFixture, planningWorkbenchUpdateFixture, shiftWorkOrdersUpdateFixture, shiftMasterBoardUpdateFixture, employeeDesktopUpdateFixture, contourAdminUpdateFixture, specifications2UpdateFixture, rolesUpdateFixture, operationsUpdateFixture, nomenclatureTypesUpdateFixture, statusesUpdateFixture];
const scenarioIndex = Math.max(scenarioParamRoutes.indexOf(scenarioParam as typeof scenarioParamRoutes[number]), 0);
const scenario = scenarioParamRoutes[scenarioIndex].replace(/-([a-z])/g, (_match, letter: string) => letter.toUpperCase()) as ReactMigrationScenarioId;
const initialPayload = labInitialPayloads[scenarioIndex];
const updatePayload = labUpdatePayloads[scenarioIndex];
