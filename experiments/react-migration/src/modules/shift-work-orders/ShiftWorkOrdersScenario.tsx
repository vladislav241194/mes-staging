...
import type { ShiftWorkOrdersFactCommand } from "./ShiftWorkOrderFactEditor";
import type * as ShiftWorkOrderPrintRenderer from "./ShiftWorkOrderPrintPreviews";

export type { ShiftWorkOrdersFactCommand } from "./ShiftWorkOrderFactEditor";
...
export function ShiftWorkOrdersScenario({ payload, onCommand, onLoadFactEditor, onLoadPrintPackage, onLoadPrintRenderer, onPrintDocument, onRequestLegacy }: { payload: unknown; onCommand?(command: ShiftWorkOrdersFactCommand): Promise<{ ok?: boolean; message?: string } | void>; onLoadFactEditor?(): Promise<typeof ShiftWorkOrderFactEditorModule>; onLoadPrintPackage?(rowId: string): Promise<unknown>; onLoadPrintRenderer?(): Promise<typeof ShiftWorkOrderPrintRenderer>; onPrintDocument?(title: string): void; onRequestLegacy?(scope?: string): void }) {
