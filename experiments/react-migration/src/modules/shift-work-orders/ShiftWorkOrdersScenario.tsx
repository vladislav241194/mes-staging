...
export function ShiftWorkOrdersScenario({ payload, onLoadPrintPackage, onLoadPrintRenderer, onPrintDocument, onRequestLegacy }: { payload: unknown; onLoadPrintPackage?(rowId: string): Promise<unknown>; onLoadPrintRenderer?(): Promise<typeof ShiftWorkOrderPrintRenderer>; onPrintDocument?(title: string): void; onRequestLegacy?(scope?: string): void }) {
