...
export interface StructureEquipmentReadModel { equipment: StructureEquipmentItem[]; counts: Record<StructureRegistryId, number>; orgUnits: StructureEquipmentOption[]; workCenters: StructureEquipmentOption[]; scheduleTemplates: StructureEquipmentOption[]; canCreateEdit: boolean; canArchive: boolean }
