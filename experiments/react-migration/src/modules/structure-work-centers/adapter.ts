...
export interface StructureWorkCentersReadModel { workCenters: StructureWorkCenter[]; counts: Record<StructureRegistryId, number>; orgUnits: StructureWorkCenterOption[]; parentWorkCenters: StructureWorkCenterOption[]; canCreateEdit: boolean; canArchive: boolean; canElevate?: boolean; writeUnavailableReason?: string }
