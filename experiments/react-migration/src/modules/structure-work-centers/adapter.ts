...
export interface StructureWorkCentersReadModel { workCenters: StructureWorkCenter[]; counts: Record<StructureRegistryId, number>; orgUnits: StructureWorkCenterOption[]; parentWorkCenters: StructureWorkCenterOption[]; canCreateEdit: boolean }
