...
export function StructurePositionsReadScenario({ payload, onNavigateRegistry }: { payload: unknown; onNavigateRegistry?(registryId: StructureRegistryId): void }) {
