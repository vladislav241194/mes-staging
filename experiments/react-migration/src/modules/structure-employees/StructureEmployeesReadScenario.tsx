...
import { adaptStructureEmployees, type StructureRegistryId } from "./adapter";
import { buildStructureRegistryOptions, resolveVisibleStructureEmployee, STRUCTURE_EMPLOYEE_READ_COLUMNS } from "./view-model";

export function StructureEmployeesReadScenario({ payload, onNavigateRegistry }: { payload: unknown; onNavigateRegistry?(registryId: StructureRegistryId): void }) {
