...
export interface StructureResponsibilityPoliciesReadModel { policies: StructureResponsibilityPolicy[]; counts: Record<StructureRegistryId, number>; employees: StructureResponsibilityEmployeeOption[]; canCreateEdit: boolean; canArchive: boolean }
