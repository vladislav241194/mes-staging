...
export interface StructureOrgUnitsReadModel { orgUnits: StructureOrgUnit[]; counts: Record<StructureRegistryId, number>; canCreateEdit: boolean; canArchive: boolean; canElevate?: boolean; writeUnavailableReason?: string }
