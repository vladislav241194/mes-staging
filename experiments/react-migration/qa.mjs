...
try {
  ...
  assert.equal(commandParityMatrix.scenarios.filter((scenario) => scenario.commandParity === "pending").length, 11, "all 11 remaining command scenarios must stay explicit");
