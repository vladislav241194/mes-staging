...
try {
  ...
  assert.equal(commandParityMatrix.scenarios.filter((scenario) => scenario.commandParity === "pending").length, 3, "all 3 remaining command scenarios must stay explicit");
