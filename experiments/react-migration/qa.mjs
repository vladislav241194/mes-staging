...
try {
  ...
  assert.equal(commandParityMatrix.scenarios.filter((scenario) => scenario.commandParity === "pending").length, 4, "all 4 remaining command scenarios must stay explicit");
