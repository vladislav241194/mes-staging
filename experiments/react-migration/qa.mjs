...
try {
  ...
  assert.equal(commandParityMatrix.scenarios.filter((scenario) => scenario.commandParity === "pending").length, 13, "all 13 remaining command scenarios must stay explicit");
