...
try {
  ...
  assert.match(productionAppSource, /const normalized = normalizeDateInput\(dateKey\)/);
  assert.match(productionAppSource, /ui\.windowStart = normalized/);
  assert.match(productionAppSource, /hydrateShiftExecutionServerProjection\(\)/);
  assert.match(productionAppSource, /selectMaster: \(masterId = ""\)/);
  assert.match(productionAppSource, /ui\.activeShiftMasterId = id/);
  assert.match(productionAppSource, /ui\.shiftMasterBoardFocus = "mine"/);
