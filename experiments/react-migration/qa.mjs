...
try {
  ...
  assert.equal(commandParityMatrix.scenarios.filter((scenario) => scenario.commandParity === "pending").length, 1, "the remaining protected command scenario must stay explicit");
