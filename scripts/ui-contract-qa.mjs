...
checkNoMatches("Запрещено возвращать мертвые CSS-хвосты текущей доски Мастерской", stylesSource, /shift-master-board-(?:load(?!-tooltip)|detail-head)/);
