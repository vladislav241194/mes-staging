...
const serverRoutes = [
  { id: "wo-1", number: "WO-1", quantity: 10, lifecycleStatus: "released", planningStatus: "scheduled", concurrencyRevision: 4, metadata: { id: "wo-1", sourceSpecifications2EntryId: "spec-1" } },
  { id: "wo-2", number: "WO-2", quantity: 20, lifecycleStatus: "queued", planningStatus: "queued", concurrencyRevision: 2, metadata: { id: "wo-2", sourceSpecifications2EntryId: "spec-1" } },
];
