...
assert(source.includes('target !== `${contour.releasesPath}/${releaseId}/app`') && source.includes("legacy-app-pre-"), "Rollback must reject targets outside the exact contour release path");
