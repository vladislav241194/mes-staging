...
assert.doesNotMatch(appSource, /ensureSpecifications2Module|getSpecifications2ReactModel|renderSpecifications2Page|bindSpecifications2Events|specifications2\/render\.js/);
...
assert.match(hostSource, /getIneligibilityReason: \(activation\) => activation\.accessMode === "react" \? "" : "runtime-inactive"/);
